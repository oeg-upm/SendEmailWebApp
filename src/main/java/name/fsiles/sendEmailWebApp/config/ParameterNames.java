...
public class ParameterNames {
	public static final String DESTINATARY = "mail.destinatary";
	public static final String MAIL_HOST = "mail.host.url";
	...
	public static final String TRYS_TO_SEND_EMAIL = "server.mail.trys.limit";
	public static final String TRYS_INTERVAL = "server.mail.trys.interval.hours";
}
